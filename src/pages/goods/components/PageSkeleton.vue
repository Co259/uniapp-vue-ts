  ...
  <view class="sk-container">
    <scroll-view :scroll-y="true" class="viewport viewport" :enable-back-to-top="true">
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-196 sk-text">16.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-515 sk-text">木天蓼逗猫棍</view>
          <view class="desc sk-transparent sk-text-0-0000-774 sk-text">零食玩具，互动磨牙app</view>
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-622 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-469 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-176 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-475 sk-text">
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-9 sk-text">服务</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-437 sk-text">
              无忧退 快速退款 免费包邮
            </text>
          </view>
        </view>
      ...
      <view class="detail detail panel panel">
        <view class="title title">
          <text class="sk-transparent sk-text-0-0000-443 sk-text">详情</text>
        </view>
        <view class="content content">
          <view class="properties properties">
            <view class="item item">
              <text class="label sk-transparent sk-text-25-0000-351 sk-text">商品名称</text>
              <text class="value sk-transparent sk-text-25-0000-990 sk-text">木天蓼逗猫棍</text>
            </view>
          </view>
        </view>
      </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-32-9268-903 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-32-9268-200 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
...
<style>
/*
此文件为开发者工具生成，生成时间: 2025/6/30下午1:45:03

在 S:\pythonProject\uniapp-vue-shop\dist\dev\mp-weixin\pages\goods\goods.wxss 中引入样式
```
